...
public class CreateAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayName = (TextInputLayout) findViewById(R.id.create_account_name);
        mEmail = (TextInputLayout) findViewById(R.id.create_account_email);
        mPassword = (TextInputLayout) findViewById(R.id.create_account_password);
        mCreateBtn = (Button) findViewById(R.id.create_account_btn);
